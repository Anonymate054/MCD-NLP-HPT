# NLP guide installation

## Set up project's module

To move beyond notebook prototyping, all reusable code should go into the `nlp_module/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `nlp_module` folder and use the modules inside your notebooks :
...
Example of module usage for `nlp_module`: 

```python
from nlp_module.utils.paths import data_dir
data_dir()
```
